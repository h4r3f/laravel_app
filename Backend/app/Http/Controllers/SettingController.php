...
class SettingController extends MController {
    ...
    public function store(CreateSettingRequest $request) {
        ...
        if ($request->hasFile('image')) {
            $input['image'] = Setting::moveFile($request->file('image'));
        }
...
//        die();
    ...
    public function update($id, UpdateSettingRequest $request) {
        ...
        $setting = $this->settingRepository->updateRich($input, $id);
    ...
    public function getAdminEmail() {
        return view('settings.adminemail');
    }
    ...
    public function postAdminEmail(Request $request) {
        ...
        $user->save();
        Flash::success('Admin email change successfully.');
        return redirect(route('settings.index'));
    }
